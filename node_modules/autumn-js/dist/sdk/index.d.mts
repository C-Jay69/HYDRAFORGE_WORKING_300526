...
/** @internal */
declare const AttachResetInterval$outboundSchema: z$1.ZodMiniEnum<typeof AttachResetInterval>;
/** @internal */
type AttachReset$Outbound = {
    interval: string;
    interval_count?: number | undefined;
};
/** @internal */
declare const AttachReset$outboundSchema: z$1.ZodMiniType<AttachReset$Outbound, AttachReset>;
declare function attachResetToJSON(attachReset: AttachReset): string;
/** @internal */
type AttachTo$Outbound = number | string;
/** @internal */
declare const AttachTo$outboundSchema: z$1.ZodMiniType<AttachTo$Outbound, AttachTo>;
declare function attachToToJSON(attachTo: AttachTo): string;
/** @internal */
type AttachTier$Outbound = {
    to: number | string;
    amount?: number | undefined;
    flat_amount?: number | undefined;
};
/** @internal */
declare const AttachTier$outboundSchema: z$1.ZodMiniType<AttachTier$Outbound, AttachTier>;
declare function attachTierToJSON(attachTier: AttachTier): string;
/** @internal */
declare const AttachTierBehavior$outboundSchema: z$1.ZodMiniEnum<typeof AttachTierBehavior>;
/** @internal */
declare const AttachItemPriceInterval$outboundSchema: z$1.ZodMiniEnum<typeof AttachItemPriceInterval>;
/** @internal */
declare const AttachBillingMethod$outboundSchema: z$1.ZodMiniEnum<typeof AttachBillingMethod>;
/** @internal */
type AttachPrice$Outbound = {
    amount?: number | undefined;
...
/** @internal */
declare const AttachPrice$outboundSchema: z$1.ZodMiniType<AttachPrice$Outbound, AttachPrice>;
declare function attachPriceToJSON(attachPrice: AttachPrice): string;
/** @internal */
declare const AttachOnIncrease$outboundSchema: z$1.ZodMiniEnum<typeof AttachOnIncrease>;
/** @internal */
declare const AttachOnDecrease$outboundSchema: z$1.ZodMiniEnum<typeof AttachOnDecrease>;
/** @internal */
type AttachProration$Outbound = {
    on_increase: string;
    on_decrease: string;
};
/** @internal */
declare const AttachProration$outboundSchema: z$1.ZodMiniType<AttachProration$Outbound, AttachProration>;
declare function attachProrationToJSON(attachProration: AttachProration): string;
/** @internal */
declare const AttachExpiryDurationType$outboundSchema: z$1.ZodMiniEnum<typeof AttachExpiryDurationType>;
/** @internal */
...
/** @internal */
declare const AttachRollover$outboundSchema: z$1.ZodMiniType<AttachRollover$Outbound, AttachRollover>;
declare function attachRolloverToJSON(attachRollover: AttachRollover): string;
/** @internal */
type AttachPlanItem$Outbound = {
    feature_id: string;
    included?: number | undefined;
    unlimited?: boolean | undefined;
...
/** @internal */
declare const AttachPlanItem$outboundSchema: z$1.ZodMiniType<AttachPlanItem$Outbound, AttachPlanItem>;
declare function attachPlanItemToJSON(attachPlanItem: AttachPlanItem): string;
/** @internal */
 ...
 */
type Interval = BalanceIntervalEnum | string;
type BalanceReset = {
    /**
     * The reset interval (hour, day, week, month, etc.) or 'multiple' if combined from different intervals.
     */
...
/** @internal */
declare const Interval$inboundSchema: z$1.ZodMiniType<Interval, unknown>;
declare function intervalFromJSON(jsonString: string): Result<Interval, SDKValidationError>;
/** @internal */
...
type BillingUpdateTo = number | string;
...
/** @internal */
declare const BillingUpdateResetInterval$outboundSchema: z$1.ZodMiniEnum<typeof BillingUpdateResetInterval>;
/** @internal */
type BillingUpdateReset$Outbound = {
    interval: string;
    interval_count?: number | undefined;
};
/** @internal */
declare const BillingUpdateReset$outboundSchema: z$1.ZodMiniType<BillingUpdateReset$Outbound, BillingUpdateReset>;
declare function billingUpdateResetToJSON(billingUpdateReset: BillingUpdateReset): string;
/** @internal */
type BillingUpdateTo$Outbound = number | string;
/** @internal */
declare const BillingUpdateTo$outboundSchema: z$1.ZodMiniType<BillingUpdateTo$Outbound, BillingUpdateTo>;
declare function billingUpdateToToJSON(billingUpdateTo: BillingUpdateTo): string;
/** @internal */
type BillingUpdateTier$Outbound = {
    to: number | string;
    amount?: number | undefined;
    flat_amount?: number | undefined;
};
/** @internal */
declare const BillingUpdateTier$outboundSchema: z$1.ZodMiniType<BillingUpdateTier$Outbound, BillingUpdateTier>;
declare function billingUpdateTierToJSON(billingUpdateTier: BillingUpdateTier): string;
/** @internal */
declare const BillingUpdateTierBehavior$outboundSchema: z$1.ZodMiniEnum<typeof BillingUpdateTierBehavior>;
/** @internal */
declare const BillingUpdateItemPriceInterval$outboundSchema: z$1.ZodMiniEnum<typeof BillingUpdateItemPriceInterval>;
/** @internal */
declare const BillingUpdateBillingMethod$outboundSchema: z$1.ZodMiniEnum<typeof BillingUpdateBillingMethod>;
/** @internal */
type BillingUpdatePrice$Outbound = {
    amount?: number | undefined;
...
/** @internal */
declare const BillingUpdatePrice$outboundSchema: z$1.ZodMiniType<BillingUpdatePrice$Outbound, BillingUpdatePrice>;
declare function billingUpdatePriceToJSON(billingUpdatePrice: BillingUpdatePrice): string;
/** @internal */
declare const BillingUpdateOnIncrease$outboundSchema: z$1.ZodMiniEnum<typeof BillingUpdateOnIncrease>;
/** @internal */
declare const BillingUpdateOnDecrease$outboundSchema: z$1.ZodMiniEnum<typeof BillingUpdateOnDecrease>;
/** @internal */
type BillingUpdateProration$Outbound = {
    on_increase: string;
    on_decrease: string;
};
/** @internal */
declare const BillingUpdateProration$outboundSchema: z$1.ZodMiniType<BillingUpdateProration$Outbound, BillingUpdateProration>;
declare function billingUpdateProrationToJSON(billingUpdateProration: BillingUpdateProration): string;
/** @internal */
declare const BillingUpdateExpiryDurationType$outboundSchema: z$1.ZodMiniEnum<typeof BillingUpdateExpiryDurationType>;
/** @internal */
...
/** @internal */
declare const BillingUpdateRollover$outboundSchema: z$1.ZodMiniType<BillingUpdateRollover$Outbound, BillingUpdateRollover>;
declare function billingUpdateRolloverToJSON(billingUpdateRollover: BillingUpdateRollover): string;
/** @internal */
type BillingUpdatePlanItem$Outbound = {
    feature_id: string;
    included?: number | undefined;
    unlimited?: boolean | undefined;
...
/** @internal */
declare const BillingUpdatePlanItem$outboundSchema: z$1.ZodMiniType<BillingUpdatePlanItem$Outbound, BillingUpdatePlanItem>;
declare function billingUpdatePlanItemToJSON(billingUpdatePlanItem: BillingUpdatePlanItem): string;
/** @internal */
...
type IncludedUsage = number | string;
...
declare const RolloverDuration: {
    readonly Month: "month";
    readonly Forever: "forever";
};
...
/** @internal */
declare const FlagType$inboundSchema: z$1.ZodMiniType<FlagType, unknown>;
/** @internal */
declare const CheckCreditSchema$inboundSchema: z$1.ZodMiniType<CheckCreditSchema, unknown>;
declare function checkCreditSchemaFromJSON(jsonString: string): Result<CheckCreditSchema, SDKValidationError>;
/** @internal */
declare const FlagDisplay$inboundSchema: z$1.ZodMiniType<FlagDisplay, unknown>;
declare function flagDisplayFromJSON(jsonString: string): Result<FlagDisplay, SDKValidationError>;
/** @internal */
declare const CheckFeature$inboundSchema: z$1.ZodMiniType<CheckFeature, unknown>;
declare function checkFeatureFromJSON(jsonString: string): Result<CheckFeature, SDKValidationError>;
/** @internal */
declare const Flag$inboundSchema: z$1.ZodMiniType<Flag, unknown>;
declare function flagFromJSON(jsonString: string): Result<Flag, SDKValidationError>;
/** @internal */
declare const Scenario$inboundSchema: z$1.ZodMiniType<Scenario, unknown>;
/** @internal */
declare const CheckEnv$inboundSchema: z$1.ZodMiniType<CheckEnv, unknown>;
/** @internal */
declare const ProductType$inboundSchema: z$1.ZodMiniType<ProductType, unknown>;
/** @internal */
declare const FeatureType$inboundSchema: z$1.ZodMiniType<FeatureType, unknown>;
/** @internal */
declare const IncludedUsage$inboundSchema: z$1.ZodMiniType<IncludedUsage, unknown>;
declare function includedUsageFromJSON(jsonString: string): Result<IncludedUsage, SDKValidationError>;
/** @internal */
declare const CheckInterval$inboundSchema: z$1.ZodMiniType<CheckInterval, unknown>;
/** @internal */
declare const CheckTierBehavior$inboundSchema: z$1.ZodMiniType<CheckTierBehavior, unknown>;
/** @internal */
declare const UsageModel$inboundSchema: z$1.ZodMiniType<UsageModel, unknown>;
/** @internal */
declare const ProductDisplay$inboundSchema: z$1.ZodMiniType<ProductDisplay, unknown>;
declare function productDisplayFromJSON(jsonString: string): Result<ProductDisplay, SDKValidationError>;
/** @internal */
declare const RolloverDuration$inboundSchema: z$1.ZodMiniType<RolloverDuration, unknown>;
/** @internal */
declare const CheckRollover$inboundSchema: z$1.ZodMiniType<CheckRollover, unknown>;
declare function checkRolloverFromJSON(jsonString: string): Result<CheckRollover, SDKValidationError>;
/** @internal */
declare const CheckOnIncrease$inboundSchema: z$1.ZodMiniType<CheckOnIncrease, unknown>;
/** @internal */
declare const CheckOnDecrease$inboundSchema: z$1.ZodMiniType<CheckOnDecrease, unknown>;
/** @internal */
declare const Config$inboundSchema: z$1.ZodMiniType<Config, unknown>;
declare function configFromJSON(jsonString: string): Result<Config, SDKValidationError>;
/** @internal */
declare const CheckItem$inboundSchema: z$1.ZodMiniType<CheckItem, unknown>;
declare function checkItemFromJSON(jsonString: string): Result<CheckItem, SDKValidationError>;
/** @internal */
declare const FreeTrialDuration$inboundSchema: z$1.ZodMiniType<FreeTrialDuration, unknown>;
/** @internal */
declare const CheckFreeTrial$inboundSchema: z$1.ZodMiniType<CheckFreeTrial, unknown>;
declare function checkFreeTrialFromJSON(jsonString: string): Result<CheckFreeTrial, SDKValidationError>;
/** @internal */
declare const ProductScenario$inboundSchema: z$1.ZodMiniType<ProductScenario, unknown>;
/** @internal */
declare const CheckProperties$inboundSchema: z$1.ZodMiniType<CheckProperties, unknown>;
declare function checkPropertiesFromJSON(jsonString: string): Result<CheckProperties, SDKValidationError>;
/** @internal */
declare const Product$inboundSchema: z$1.ZodMiniType<Product, unknown>;
declare function productFromJSON(jsonString: string): Result<Product, SDKValidationError>;
/** @internal */
declare const Preview$inboundSchema: z$1.ZodMiniType<Preview, unknown>;
declare function previewFromJSON(jsonString: string): Result<Preview, SDKValidationError>;
/** @internal */
...
/** @internal */
declare const CustomerDataInterval$outboundSchema: z$1.ZodMiniEnum<typeof CustomerDataInterval>;
/** @internal */
...
/** @internal */
declare const CreateFeatureTypeRequest$outboundSchema: z$1.ZodMiniEnum<typeof CreateFeatureTypeRequest>;
/** @internal */
type CreateFeatureDisplayRequest$Outbound = {
    singular: string;
    plural: string;
};
/** @internal */
declare const CreateFeatureDisplayRequest$outboundSchema: z$1.ZodMiniType<CreateFeatureDisplayRequest$Outbound, CreateFeatureDisplayRequest>;
declare function createFeatureDisplayRequestToJSON(createFeatureDisplayRequest: CreateFeatureDisplayRequest): string;
/** @internal */
type CreateFeatureCreditSchemaRequest$Outbound = {
    metered_feature_id: string;
    credit_cost: number;
};
/** @internal */
declare const CreateFeatureCreditSchemaRequest$outboundSchema: z$1.ZodMiniType<CreateFeatureCreditSchemaRequest$Outbound, CreateFeatureCreditSchemaRequest>;
declare function createFeatureCreditSchemaRequestToJSON(createFeatureCreditSchemaRequest: CreateFeatureCreditSchemaRequest): string;
/** @internal */
...
type CreatePlanTo = number | string;
type CreatePlanTier = {
    to: number | string;
    amount?: number | undefined;
    flatAmount?: number | undefined;
...
/** @internal */
declare const CreatePlanPriceIntervalRequest$outboundSchema: z$1.ZodMiniEnum<typeof CreatePlanPriceIntervalRequest>;
/** @internal */
type CreatePlanPriceRequest$Outbound = {
    amount: number;
    interval: string;
    interval_count?: number | undefined;
};
/** @internal */
declare const CreatePlanPriceRequest$outboundSchema: z$1.ZodMiniType<CreatePlanPriceRequest$Outbound, CreatePlanPriceRequest>;
declare function createPlanPriceRequestToJSON(createPlanPriceRequest: CreatePlanPriceRequest): string;
/** @internal */
declare const CreatePlanResetIntervalRequest$outboundSchema: z$1.ZodMiniEnum<typeof CreatePlanResetIntervalRequest>;
/** @internal */
type CreatePlanResetRequest$Outbound = {
    interval: string;
    interval_count?: number | undefined;
};
/** @internal */
declare const CreatePlanResetRequest$outboundSchema: z$1.ZodMiniType<CreatePlanResetRequest$Outbound, CreatePlanResetRequest>;
declare function createPlanResetRequestToJSON(createPlanResetRequest: CreatePlanResetRequest): string;
/** @internal */
type CreatePlanTo$Outbound = number | string;
/** @internal */
declare const CreatePlanTo$outboundSchema: z$1.ZodMiniType<CreatePlanTo$Outbound, CreatePlanTo>;
declare function createPlanToToJSON(createPlanTo: CreatePlanTo): string;
/** @internal */
type CreatePlanTier$Outbound = {
    to: number | string;
    amount?: number | undefined;
    flat_amount?: number | undefined;
};
/** @internal */
declare const CreatePlanTier$outboundSchema: z$1.ZodMiniType<CreatePlanTier$Outbound, CreatePlanTier>;
declare function createPlanTierToJSON(createPlanTier: CreatePlanTier): string;
/** @internal */
declare const CreatePlanTierBehaviorRequest$outboundSchema: z$1.ZodMiniEnum<typeof CreatePlanTierBehaviorRequest>;
/** @internal */
declare const CreatePlanItemPriceIntervalRequest$outboundSchema: z$1.ZodMiniEnum<typeof CreatePlanItemPriceIntervalRequest>;
/** @internal */
declare const CreatePlanBillingMethodRequest$outboundSchema: z$1.ZodMiniEnum<typeof CreatePlanBillingMethodRequest>;
/** @internal */
type CreatePlanItemPriceRequest$Outbound = {
    amount?: number | undefined;
...
/** @internal */
declare const CreatePlanItemPriceRequest$outboundSchema: z$1.ZodMiniType<CreatePlanItemPriceRequest$Outbound, CreatePlanItemPriceRequest>;
declare function createPlanItemPriceRequestToJSON(createPlanItemPriceRequest: CreatePlanItemPriceRequest): string;
/** @internal */
declare const CreatePlanOnIncrease$outboundSchema: z$1.ZodMiniEnum<typeof CreatePlanOnIncrease>;
/** @internal */
declare const CreatePlanOnDecrease$outboundSchema: z$1.ZodMiniEnum<typeof CreatePlanOnDecrease>;
/** @internal */
type CreatePlanProration$Outbound = {
    on_increase: string;
    on_decrease: string;
};
/** @internal */
declare const CreatePlanProration$outboundSchema: z$1.ZodMiniType<CreatePlanProration$Outbound, CreatePlanProration>;
declare function createPlanProrationToJSON(createPlanProration: CreatePlanProration): string;
/** @internal */
declare const CreatePlanExpiryDurationTypeRequest$outboundSchema: z$1.ZodMiniEnum<typeof CreatePlanExpiryDurationTypeRequest>;
/** @internal */
...
/** @internal */
declare const CreatePlanRolloverRequest$outboundSchema: z$1.ZodMiniType<CreatePlanRolloverRequest$Outbound, CreatePlanRolloverRequest>;
declare function createPlanRolloverRequestToJSON(createPlanRolloverRequest: CreatePlanRolloverRequest): string;
/** @internal */
type CreatePlanPlanItem$Outbound = {
    feature_id: string;
    included?: number | undefined;
    unlimited?: boolean | undefined;
...
/** @internal */
declare const CreatePlanPlanItem$outboundSchema: z$1.ZodMiniType<CreatePlanPlanItem$Outbound, CreatePlanPlanItem>;
declare function createPlanPlanItemToJSON(createPlanPlanItem: CreatePlanPlanItem): string;
/** @internal */
...
/** @internal */
declare const CustomerInterval$inboundSchema: z$1.ZodMiniType<CustomerInterval, unknown>;
/** @internal */
declare const CustomerPurchaseLimit$inboundSchema: z$1.ZodMiniType<CustomerPurchaseLimit, unknown>;
declare function customerPurchaseLimitFromJSON(jsonString: string): Result<CustomerPurchaseLimit, SDKValidationError>;
/** @internal */
...
/** @internal */
declare const EntityEnv$inboundSchema: z$1.ZodMiniType<EntityEnv, unknown>;
/** @internal */
...
/** @internal */
declare const RewardsType$inboundSchema: z$1.ZodMiniType<RewardsType, unknown>;
/** @internal */
...
/** @internal */
declare const Rewards$inboundSchema: z$1.ZodMiniType<Rewards, unknown>;
declare function rewardsFromJSON(jsonString: string): Result<Rewards, SDKValidationError>;
/** @internal */
...
/** @internal */
declare const GetOrCreateCustomerInterval$outboundSchema: z$1.ZodMiniEnum<typeof GetOrCreateCustomerInterval>;
/** @internal */
...
/** @internal */
declare const SubscriptionStatus$outboundSchema: z$1.ZodMiniEnum<typeof SubscriptionStatus>;
/** @internal */
...
/** @internal */
declare const ListCustomersInterval$inboundSchema: z$1.ZodMiniType<ListCustomersInterval, unknown>;
/** @internal */
declare const ListCustomersPurchaseLimit$inboundSchema: z$1.ZodMiniType<ListCustomersPurchaseLimit, unknown>;
declare function listCustomersPurchaseLimitFromJSON(jsonString: string): Result<ListCustomersPurchaseLimit, SDKValidationError>;
/** @internal */
...
/** @internal */
declare const ListEventsProperties$inboundSchema: z$1.ZodMiniType<ListEventsProperties, unknown>;
declare function listEventsPropertiesFromJSON(jsonString: string): Result<ListEventsProperties, SDKValidationError>;
/** @internal */
...
type PreviewAttachTo = number | string;
...
/** @internal */
declare const PreviewAttachResetInterval$outboundSchema: z$1.ZodMiniEnum<typeof PreviewAttachResetInterval>;
/** @internal */
type PreviewAttachReset$Outbound = {
    interval: string;
    interval_count?: number | undefined;
};
/** @internal */
declare const PreviewAttachReset$outboundSchema: z$1.ZodMiniType<PreviewAttachReset$Outbound, PreviewAttachReset>;
declare function previewAttachResetToJSON(previewAttachReset: PreviewAttachReset): string;
/** @internal */
type PreviewAttachTo$Outbound = number | string;
/** @internal */
declare const PreviewAttachTo$outboundSchema: z$1.ZodMiniType<PreviewAttachTo$Outbound, PreviewAttachTo>;
declare function previewAttachToToJSON(previewAttachTo: PreviewAttachTo): string;
/** @internal */
type PreviewAttachTier$Outbound = {
    to: number | string;
    amount?: number | undefined;
    flat_amount?: number | undefined;
};
/** @internal */
declare const PreviewAttachTier$outboundSchema: z$1.ZodMiniType<PreviewAttachTier$Outbound, PreviewAttachTier>;
declare function previewAttachTierToJSON(previewAttachTier: PreviewAttachTier): string;
/** @internal */
declare const PreviewAttachTierBehavior$outboundSchema: z$1.ZodMiniEnum<typeof PreviewAttachTierBehavior>;
/** @internal */
declare const PreviewAttachItemPriceInterval$outboundSchema: z$1.ZodMiniEnum<typeof PreviewAttachItemPriceInterval>;
/** @internal */
declare const PreviewAttachBillingMethod$outboundSchema: z$1.ZodMiniEnum<typeof PreviewAttachBillingMethod>;
/** @internal */
type PreviewAttachPrice$Outbound = {
    amount?: number | undefined;
...
/** @internal */
declare const PreviewAttachPrice$outboundSchema: z$1.ZodMiniType<PreviewAttachPrice$Outbound, PreviewAttachPrice>;
declare function previewAttachPriceToJSON(previewAttachPrice: PreviewAttachPrice): string;
/** @internal */
declare const PreviewAttachOnIncrease$outboundSchema: z$1.ZodMiniEnum<typeof PreviewAttachOnIncrease>;
/** @internal */
declare const PreviewAttachOnDecrease$outboundSchema: z$1.ZodMiniEnum<typeof PreviewAttachOnDecrease>;
/** @internal */
type PreviewAttachProration$Outbound = {
    on_increase: string;
    on_decrease: string;
};
/** @internal */
declare const PreviewAttachProration$outboundSchema: z$1.ZodMiniType<PreviewAttachProration$Outbound, PreviewAttachProration>;
declare function previewAttachProrationToJSON(previewAttachProration: PreviewAttachProration): string;
/** @internal */
declare const PreviewAttachExpiryDurationType$outboundSchema: z$1.ZodMiniEnum<typeof PreviewAttachExpiryDurationType>;
/** @internal */
...
/** @internal */
declare const PreviewAttachRollover$outboundSchema: z$1.ZodMiniType<PreviewAttachRollover$Outbound, PreviewAttachRollover>;
declare function previewAttachRolloverToJSON(previewAttachRollover: PreviewAttachRollover): string;
/** @internal */
type PreviewAttachPlanItem$Outbound = {
    feature_id: string;
    included?: number | undefined;
    unlimited?: boolean | undefined;
...
/** @internal */
declare const PreviewAttachPlanItem$outboundSchema: z$1.ZodMiniType<PreviewAttachPlanItem$Outbound, PreviewAttachPlanItem>;
declare function previewAttachPlanItemToJSON(previewAttachPlanItem: PreviewAttachPlanItem): string;
/** @internal */
...
type PreviewUpdateTo = number | string;
...
/** @internal */
declare const PreviewUpdateResetInterval$outboundSchema: z$1.ZodMiniEnum<typeof PreviewUpdateResetInterval>;
/** @internal */
type PreviewUpdateReset$Outbound = {
    interval: string;
    interval_count?: number | undefined;
};
/** @internal */
declare const PreviewUpdateReset$outboundSchema: z$1.ZodMiniType<PreviewUpdateReset$Outbound, PreviewUpdateReset>;
declare function previewUpdateResetToJSON(previewUpdateReset: PreviewUpdateReset): string;
/** @internal */
type PreviewUpdateTo$Outbound = number | string;
/** @internal */
declare const PreviewUpdateTo$outboundSchema: z$1.ZodMiniType<PreviewUpdateTo$Outbound, PreviewUpdateTo>;
declare function previewUpdateToToJSON(previewUpdateTo: PreviewUpdateTo): string;
/** @internal */
type PreviewUpdateTier$Outbound = {
    to: number | string;
    amount?: number | undefined;
    flat_amount?: number | undefined;
};
/** @internal */
declare const PreviewUpdateTier$outboundSchema: z$1.ZodMiniType<PreviewUpdateTier$Outbound, PreviewUpdateTier>;
declare function previewUpdateTierToJSON(previewUpdateTier: PreviewUpdateTier): string;
/** @internal */
declare const PreviewUpdateTierBehavior$outboundSchema: z$1.ZodMiniEnum<typeof PreviewUpdateTierBehavior>;
/** @internal */
declare const PreviewUpdateItemPriceInterval$outboundSchema: z$1.ZodMiniEnum<typeof PreviewUpdateItemPriceInterval>;
/** @internal */
declare const PreviewUpdateBillingMethod$outboundSchema: z$1.ZodMiniEnum<typeof PreviewUpdateBillingMethod>;
/** @internal */
type PreviewUpdatePrice$Outbound = {
    amount?: number | undefined;
...
/** @internal */
declare const PreviewUpdatePrice$outboundSchema: z$1.ZodMiniType<PreviewUpdatePrice$Outbound, PreviewUpdatePrice>;
declare function previewUpdatePriceToJSON(previewUpdatePrice: PreviewUpdatePrice): string;
/** @internal */
declare const PreviewUpdateOnIncrease$outboundSchema: z$1.ZodMiniEnum<typeof PreviewUpdateOnIncrease>;
/** @internal */
declare const PreviewUpdateOnDecrease$outboundSchema: z$1.ZodMiniEnum<typeof PreviewUpdateOnDecrease>;
/** @internal */
type PreviewUpdateProration$Outbound = {
    on_increase: string;
    on_decrease: string;
};
/** @internal */
declare const PreviewUpdateProration$outboundSchema: z$1.ZodMiniType<PreviewUpdateProration$Outbound, PreviewUpdateProration>;
declare function previewUpdateProrationToJSON(previewUpdateProration: PreviewUpdateProration): string;
/** @internal */
declare const PreviewUpdateExpiryDurationType$outboundSchema: z$1.ZodMiniEnum<typeof PreviewUpdateExpiryDurationType>;
/** @internal */
...
/** @internal */
declare const PreviewUpdateRollover$outboundSchema: z$1.ZodMiniType<PreviewUpdateRollover$Outbound, PreviewUpdateRollover>;
declare function previewUpdateRolloverToJSON(previewUpdateRollover: PreviewUpdateRollover): string;
/** @internal */
type PreviewUpdatePlanItem$Outbound = {
    feature_id: string;
    included?: number | undefined;
    unlimited?: boolean | undefined;
...
/** @internal */
declare const PreviewUpdatePlanItem$outboundSchema: z$1.ZodMiniType<PreviewUpdatePlanItem$Outbound, PreviewUpdatePlanItem>;
declare function previewUpdatePlanItemToJSON(previewUpdatePlanItem: PreviewUpdatePlanItem): string;
/** @internal */
...
type SetupPaymentTo = number | string;
...
/** @internal */
declare const SetupPaymentResetInterval$outboundSchema: z$1.ZodMiniEnum<typeof SetupPaymentResetInterval>;
/** @internal */
type SetupPaymentReset$Outbound = {
    interval: string;
    interval_count?: number | undefined;
};
/** @internal */
declare const SetupPaymentReset$outboundSchema: z$1.ZodMiniType<SetupPaymentReset$Outbound, SetupPaymentReset>;
declare function setupPaymentResetToJSON(setupPaymentReset: SetupPaymentReset): string;
/** @internal */
type SetupPaymentTo$Outbound = number | string;
/** @internal */
declare const SetupPaymentTo$outboundSchema: z$1.ZodMiniType<SetupPaymentTo$Outbound, SetupPaymentTo>;
declare function setupPaymentToToJSON(setupPaymentTo: SetupPaymentTo): string;
/** @internal */
type SetupPaymentTier$Outbound = {
    to: number | string;
    amount?: number | undefined;
    flat_amount?: number | undefined;
};
/** @internal */
declare const SetupPaymentTier$outboundSchema: z$1.ZodMiniType<SetupPaymentTier$Outbound, SetupPaymentTier>;
declare function setupPaymentTierToJSON(setupPaymentTier: SetupPaymentTier): string;
/** @internal */
declare const SetupPaymentTierBehavior$outboundSchema: z$1.ZodMiniEnum<typeof SetupPaymentTierBehavior>;
/** @internal */
declare const SetupPaymentItemPriceInterval$outboundSchema: z$1.ZodMiniEnum<typeof SetupPaymentItemPriceInterval>;
/** @internal */
declare const SetupPaymentBillingMethod$outboundSchema: z$1.ZodMiniEnum<typeof SetupPaymentBillingMethod>;
/** @internal */
type SetupPaymentPrice$Outbound = {
    amount?: number | undefined;
...
/** @internal */
declare const SetupPaymentPrice$outboundSchema: z$1.ZodMiniType<SetupPaymentPrice$Outbound, SetupPaymentPrice>;
declare function setupPaymentPriceToJSON(setupPaymentPrice: SetupPaymentPrice): string;
/** @internal */
declare const SetupPaymentOnIncrease$outboundSchema: z$1.ZodMiniEnum<typeof SetupPaymentOnIncrease>;
/** @internal */
declare const SetupPaymentOnDecrease$outboundSchema: z$1.ZodMiniEnum<typeof SetupPaymentOnDecrease>;
/** @internal */
type SetupPaymentProration$Outbound = {
    on_increase: string;
    on_decrease: string;
};
/** @internal */
declare const SetupPaymentProration$outboundSchema: z$1.ZodMiniType<SetupPaymentProration$Outbound, SetupPaymentProration>;
declare function setupPaymentProrationToJSON(setupPaymentProration: SetupPaymentProration): string;
/** @internal */
declare const SetupPaymentExpiryDurationType$outboundSchema: z$1.ZodMiniEnum<typeof SetupPaymentExpiryDurationType>;
/** @internal */
...
/** @internal */
declare const SetupPaymentRollover$outboundSchema: z$1.ZodMiniType<SetupPaymentRollover$Outbound, SetupPaymentRollover>;
declare function setupPaymentRolloverToJSON(setupPaymentRollover: SetupPaymentRollover): string;
/** @internal */
type SetupPaymentPlanItem$Outbound = {
    feature_id: string;
    included?: number | undefined;
    unlimited?: boolean | undefined;
...
/** @internal */
declare const SetupPaymentPlanItem$outboundSchema: z$1.ZodMiniType<SetupPaymentPlanItem$Outbound, SetupPaymentPlanItem>;
declare function setupPaymentPlanItemToJSON(setupPaymentPlanItem: SetupPaymentPlanItem): string;
/** @internal */
...
/** @internal */
declare const UpdateCustomerIntervalRequest$outboundSchema: z$1.ZodMiniEnum<typeof UpdateCustomerIntervalRequest>;
/** @internal */
...
/** @internal */
declare const UpdateCustomerIntervalResponse$inboundSchema: z$1.ZodMiniType<UpdateCustomerIntervalResponse, unknown>;
/** @internal */
declare const UpdateCustomerPurchaseLimitResponse$inboundSchema: z$1.ZodMiniType<UpdateCustomerPurchaseLimitResponse, unknown>;
declare function updateCustomerPurchaseLimitResponseFromJSON(jsonString: string): Result<UpdateCustomerPurchaseLimitResponse, SDKValidationError>;
/** @internal */
...
/** @internal */
declare const UpdateFeatureTypeRequest$outboundSchema: z$1.ZodMiniEnum<typeof UpdateFeatureTypeRequest>;
/** @internal */
type UpdateFeatureDisplayRequest$Outbound = {
    singular: string;
    plural: string;
};
/** @internal */
declare const UpdateFeatureDisplayRequest$outboundSchema: z$1.ZodMiniType<UpdateFeatureDisplayRequest$Outbound, UpdateFeatureDisplayRequest>;
declare function updateFeatureDisplayRequestToJSON(updateFeatureDisplayRequest: UpdateFeatureDisplayRequest): string;
/** @internal */
type UpdateFeatureCreditSchemaRequest$Outbound = {
    metered_feature_id: string;
    credit_cost: number;
};
/** @internal */
declare const UpdateFeatureCreditSchemaRequest$outboundSchema: z$1.ZodMiniType<UpdateFeatureCreditSchemaRequest$Outbound, UpdateFeatureCreditSchemaRequest>;
declare function updateFeatureCreditSchemaRequestToJSON(updateFeatureCreditSchemaRequest: UpdateFeatureCreditSchemaRequest): string;
/** @internal */
...
type UpdatePlanTo = number | string;
type UpdatePlanTier = {
    to: number | string;
    amount?: number | undefined;
    flatAmount?: number | undefined;
...
/** @internal */
declare const UpdatePlanPriceIntervalRequest$outboundSchema: z$1.ZodMiniEnum<typeof UpdatePlanPriceIntervalRequest>;
/** @internal */
type UpdatePlanBasePrice$Outbound = {
    amount: number;
    interval: string;
    interval_count?: number | undefined;
};
/** @internal */
declare const UpdatePlanBasePrice$outboundSchema: z$1.ZodMiniType<UpdatePlanBasePrice$Outbound, UpdatePlanBasePrice>;
declare function updatePlanBasePriceToJSON(updatePlanBasePrice: UpdatePlanBasePrice): string;
/** @internal */
declare const UpdatePlanResetIntervalRequest$outboundSchema: z$1.ZodMiniEnum<typeof UpdatePlanResetIntervalRequest>;
/** @internal */
type UpdatePlanResetRequest$Outbound = {
    interval: string;
    interval_count?: number | undefined;
};
/** @internal */
declare const UpdatePlanResetRequest$outboundSchema: z$1.ZodMiniType<UpdatePlanResetRequest$Outbound, UpdatePlanResetRequest>;
declare function updatePlanResetRequestToJSON(updatePlanResetRequest: UpdatePlanResetRequest): string;
/** @internal */
type UpdatePlanTo$Outbound = number | string;
/** @internal */
declare const UpdatePlanTo$outboundSchema: z$1.ZodMiniType<UpdatePlanTo$Outbound, UpdatePlanTo>;
declare function updatePlanToToJSON(updatePlanTo: UpdatePlanTo): string;
/** @internal */
type UpdatePlanTier$Outbound = {
    to: number | string;
    amount?: number | undefined;
    flat_amount?: number | undefined;
};
/** @internal */
declare const UpdatePlanTier$outboundSchema: z$1.ZodMiniType<UpdatePlanTier$Outbound, UpdatePlanTier>;
declare function updatePlanTierToJSON(updatePlanTier: UpdatePlanTier): string;
/** @internal */
declare const UpdatePlanTierBehaviorRequest$outboundSchema: z$1.ZodMiniEnum<typeof UpdatePlanTierBehaviorRequest>;
/** @internal */
declare const UpdatePlanItemPriceIntervalRequest$outboundSchema: z$1.ZodMiniEnum<typeof UpdatePlanItemPriceIntervalRequest>;
/** @internal */
declare const UpdatePlanBillingMethodRequest$outboundSchema: z$1.ZodMiniEnum<typeof UpdatePlanBillingMethodRequest>;
/** @internal */
type UpdatePlanPriceRequest$Outbound = {
    amount?: number | undefined;
...
/** @internal */
declare const UpdatePlanPriceRequest$outboundSchema: z$1.ZodMiniType<UpdatePlanPriceRequest$Outbound, UpdatePlanPriceRequest>;
declare function updatePlanPriceRequestToJSON(updatePlanPriceRequest: UpdatePlanPriceRequest): string;
/** @internal */
declare const UpdatePlanOnIncrease$outboundSchema: z$1.ZodMiniEnum<typeof UpdatePlanOnIncrease>;
/** @internal */
declare const UpdatePlanOnDecrease$outboundSchema: z$1.ZodMiniEnum<typeof UpdatePlanOnDecrease>;
/** @internal */
type UpdatePlanProration$Outbound = {
    on_increase: string;
    on_decrease: string;
};
/** @internal */
declare const UpdatePlanProration$outboundSchema: z$1.ZodMiniType<UpdatePlanProration$Outbound, UpdatePlanProration>;
declare function updatePlanProrationToJSON(updatePlanProration: UpdatePlanProration): string;
/** @internal */
declare const UpdatePlanExpiryDurationTypeRequest$outboundSchema: z$1.ZodMiniEnum<typeof UpdatePlanExpiryDurationTypeRequest>;
/** @internal */
...
/** @internal */
declare const UpdatePlanRolloverRequest$outboundSchema: z$1.ZodMiniType<UpdatePlanRolloverRequest$Outbound, UpdatePlanRolloverRequest>;
declare function updatePlanRolloverRequestToJSON(updatePlanRolloverRequest: UpdatePlanRolloverRequest): string;
/** @internal */
type UpdatePlanPlanItem$Outbound = {
    feature_id: string;
    included?: number | undefined;
    unlimited?: boolean | undefined;
...
/** @internal */
declare const UpdatePlanPlanItem$outboundSchema: z$1.ZodMiniType<UpdatePlanPlanItem$Outbound, UpdatePlanPlanItem>;
declare function updatePlanPlanItemToJSON(updatePlanPlanItem: UpdatePlanPlanItem): string;
/** @internal */
declare const UpdatePlanDurationTypeRequest$outboundSchema: z$1.ZodMiniEnum<typeof UpdatePlanDurationTypeRequest>;
/** @internal */
type UpdatePlanFreeTrialParams$Outbound = {
    duration_length: number;
    duration_type: string;
    card_required: boolean;
};
/** @internal */
declare const UpdatePlanFreeTrialParams$outboundSchema: z$1.ZodMiniType<UpdatePlanFreeTrialParams$Outbound, UpdatePlanFreeTrialParams>;
declare function updatePlanFreeTrialParamsToJSON(updatePlanFreeTrialParams: UpdatePlanFreeTrialParams): string;
/** @internal */
...
declare function optional<T extends z$1.ZodMiniType>(t: T): z$1.ZodMiniUnion<readonly [z$1.ZodMiniUndefined, z$1.ZodMiniPipe<z$1.ZodMiniNull, z$1.ZodMiniTransform<never, null>>, T]>;
