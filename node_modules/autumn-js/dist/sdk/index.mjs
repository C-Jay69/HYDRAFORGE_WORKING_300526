...
var Config$inboundSchema = z39.pipe(
  z39.object({
    rollover: z39.optional(z39.nullable(z39.lazy(() => CheckRollover$inboundSchema))),
...
var CheckItem$inboundSchema = z39.pipe(
  z39.object({
    ...
    config: z39.optional(z39.nullable(z39.lazy(() => Config$inboundSchema)))
  }),
  z39.transform((v) => {
    return remap(v, {
      "feature_id": "featureId",
...
var CheckProperties$inboundSchema = z39.pipe(
  z39.object({
    is_free: boolean2(),
    is_one_off: boolean2(),
...
var Product$inboundSchema = z39.pipe(
  z39.object({
    ...
    properties: optional2(z39.lazy(() => CheckProperties$inboundSchema))
  }),
  z39.transform((v) => {
    return remap(v, {
      "is_add_on": "isAddOn",
...
var ListEventsProperties$inboundSchema = z39.object({});
...
var ListEventsList$inboundSchema = z39.pipe(
  z39.object({
    ...
    customer_id: string4(),
    value: number2(),
    properties: z39.lazy(() => ListEventsProperties$inboundSchema)
  }),
  z39.transform((v) => {
    return remap(v, {
      "feature_id": "featureId",
