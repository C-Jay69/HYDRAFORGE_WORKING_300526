...
var useCustomerActions_exports = {};
__export(useCustomerActions_exports, {
...
var useCustomerActions = ({
  ...
  const previewAttach = (0, import_react.useCallback)(
    async (params) => {
      return client.previewAttach(params);
    },
    [client]
  );
  const updateSubscription = (0, import_react.useCallback)(
    async (params) => {
  ...
  const previewUpdateSubscription = (0, import_react.useCallback)(
    async (params) => {
  ...
  const openCustomerPortal = (0, import_react.useCallback)(
    async (params = {}) => {
  ...
  const multiAttach = (0, import_react.useCallback)(
    async (params) => {
  ...
  const previewMultiAttach = (0, import_react.useCallback)(
    async (params) => {
      return client.previewMultiAttach(params);
    },
    [client]
  );
  const setupPayment = (0, import_react.useCallback)(
    async (params = {}) => {
