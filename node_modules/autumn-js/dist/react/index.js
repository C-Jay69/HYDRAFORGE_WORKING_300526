...
__export(index_exports, {
  ...
  useAutumnClient: () => useAutumnClient,
...
var useCustomerActions = ({
  ...
  const attach = (0, import_react4.useCallback)(
    async (params) => {
  ...
  const previewAttach = (0, import_react4.useCallback)(
    async (params) => {
      return client.previewAttach(params);
    },
    [client]
  );
  const updateSubscription = (0, import_react4.useCallback)(
    async (params) => {
  ...
  const previewUpdateSubscription = (0, import_react4.useCallback)(
    async (params) => {
  ...
  const openCustomerPortal = (0, import_react4.useCallback)(
    async (params = {}) => {
  ...
  const multiAttach = (0, import_react4.useCallback)(
    async (params) => {
  ...
  const previewMultiAttach = (0, import_react4.useCallback)(
    async (params) => {
      return client.previewMultiAttach(params);
    },
    [client]
  );
  const setupPayment = (0, import_react4.useCallback)(
    async (params = {}) => {
...
var useListEvents = (params = {}) => {
  ...
  const goToPage = (0, import_react5.useCallback)(({ pageNum }) => {
...
var useReferrals = (params) => {
  ...
  const redeemCode = (0, import_react6.useCallback)(
    async (redeemParams) => {
