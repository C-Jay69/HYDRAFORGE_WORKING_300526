...
// src/better-auth/utils/index.ts
var utils_exports = {};
__export(utils_exports, {
  ...
  omitProtectedBodyFields: () => omitProtectedBodyFields,
...
var Config$inboundSchema = z29.pipe(
  z29.object({
    rollover: z29.optional(z29.nullable(z29.lazy(() => CheckRollover$inboundSchema))),
...
var CheckItem$inboundSchema = z29.pipe(
  z29.object({
    ...
    config: z29.optional(z29.nullable(z29.lazy(() => Config$inboundSchema)))
  }),
  z29.transform((v) => {
    return remap(v, {
      "feature_id": "featureId",
...
var CheckProperties$inboundSchema = z29.pipe(
  z29.object({
    is_free: boolean2(),
    is_one_off: boolean2(),
...
var Product$inboundSchema = z29.pipe(
  z29.object({
    ...
    properties: optional2(z29.lazy(() => CheckProperties$inboundSchema))
  }),
  z29.transform((v) => {
    return remap(v, {
      "is_add_on": "isAddOn",
...
var ListEventsProperties$inboundSchema = z49.object({});
var ListEventsList$inboundSchema = z49.pipe(
  z49.object({
    ...
    customer_id: string4(),
    value: number2(),
    properties: z49.lazy(() => ListEventsProperties$inboundSchema)
  }),
  z49.transform((v) => {
    return remap(v, {
      "feature_id": "featureId",
